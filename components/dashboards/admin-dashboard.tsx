                                    ...
                                    <div className="rounded-md border min-w-[800px]">
                                        ...
                                        <div className="divide-y">
                                            ...
                                            {filteredUsers.length === 0 && (
                                                <div className="p-4 text-center text-muted-foreground">Пользователи не
                                                    найдены</div>
                                            )}
                                        </div>
                                    </div>
                                ...
                                <div className="overflow-x-auto">
                                    <div className="rounded-md border min-w-[800px]">
                                        ...
                                        <div className="divide-y">
                                            ...
                                            {groups.length === 0 && (
                                                <div className="p-4 text-center text-muted-foreground">Группы не
                                                    найдены</div>
                                            )}
                                        </div>
                                    </div>
                                ...
                                <div className="overflow-x-auto">
                                    <div className="rounded-md border min-w-[600px]">
                                        ...
                                        <div className="divide-y">
                                            ...
                                            {semesters.length === 0 && (
                                                <div className="p-4 text-center text-muted-foreground">Семестры не
                                                    найдены</div>
                                            )}
                                        </div>
                                    </div>
                        ...
                        <CardContent>
                            ...
                            {loading ? (
                                ...
                                <div className="overflow-x-auto">
                                    <div className="rounded-md border min-w-[800px]">
                                        <div className="grid grid-cols-12 p-4 text-sm font-medium bg-muted">
                                            <div className="col-span-3 flex items-center gap-1 cursor-pointer"
                                        ...
                                        <div className="divide-y">
                                            {paginatedOperations.map((operation) => (
                                                <div key={operation.id}
                                                     className="grid grid-cols-12 p-4 text-sm items-center">
                                                    <div
                                                        className="col-span-3">{formatDateTime(operation.created_at)}</div>
                                                    <div className="col-span-2">
                                                        {operation.initiator ? (
                                                            <Button
                                                                variant="link"
                                ...
                                {operationTypeNames[operation.type as keyof typeof operationTypeNames] ||
                                    operation.type}
                                            ...
                                            {filteredOperations.length === 0 && (
                                                <div className="p-4 text-center text-muted-foreground">Действия не
                                                    найдены</div>
                                            )}
                                        </div>
                                    </div>
                    ...
                    <div className="grid gap-4 py-4">
                        ...
                        <div className="space-y-2">
                            ...
                            <Select
                                ...
                                onValueChange={(value: "student" | "observer" | "accountant" | "admin") => setNewUserForm({
                                    ...newUserForm,
                                    role: value
                                })}
                            >
